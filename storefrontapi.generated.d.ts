...
export type HeroMetaobjectQuery = {
...
export type NewsletterMetaobjectQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
...
export type NewsletterMetaobjectQuery = {
  metaobject?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metaobject, 'id' | 'handle'> & {
...
export type IndexProductVariantFragment = Pick<
  StorefrontAPI.ProductVariant,
...
export type ProductItemFullFragment = Pick<
  StorefrontAPI.Product,
  | 'id'
  | 'handle'
  | 'title'
...
export type CollectionImageFragment = Pick<
  StorefrontAPI.Collection,
  'id' | 'title' | 'handle'
> & {
  image?: StorefrontAPI.Maybe<
...
export type CollectionImageQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type CollectionImageQuery = {
  collection?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
      image?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Image, 'id' | 'url' | 'altText' | 'width' | 'height'>
...
export type S25CollectionFragment = Pick<
  StorefrontAPI.Collection,
  'id' | 'title' | 'handle'
> & {
  image?: StorefrontAPI.Maybe<
...
export type S25CollectionQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type S25CollectionQuery = {
  collection?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
      image?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Image, 'id' | 'url' | 'altText' | 'width' | 'height'>
...
export type ProductCollectionsQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type ProductCollectionsQuery = {
  product?: StorefrontAPI.Maybe<{
    collections: {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query HeroMetaobject($handle: String!, $country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    metaobject(handle: { type: "hero", handle: $handle }) {\n      id\n      handle\n      fields {\n        key\n        value\n        reference {\n          __typename\n          ... on Video {\n            sources { url mimeType }\n          }\n          ... on MediaImage {\n            image { url altText width height }\n          }\n          ... on Collection {\n            handle\n          }\n        }\n      }\n    }\n    heroSlides: metaobjects(type: "hero_slide", first: 10) {\n      nodes {\n        id\n        handle\n        fields {\n          key\n          value\n          reference {\n            __typename\n            ... on Video {\n              sources { url mimeType }\n            }\n            ... on MediaImage {\n              image { url altText width height }\n            }\n            ... on Collection {\n              handle\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    ...
    variables: HeroMetaobjectQueryVariables;
  };
  '#graphql\n  query NewsletterMetaobject($handle: String!, $type: String!, $country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    metaobject(handle: { type: $type, handle: $handle }) {\n      id\n      handle\n      fields {\n        key\n        value\n      }\n    }\n  }\n': {
    return: NewsletterMetaobjectQuery;
    variables: NewsletterMetaobjectQueryVariables;
  };
  ...
  '#graphql\n  fragment CollectionImage on Collection {\n    id\n    title\n    image {\n      id\n      url\n      altText\n      width\n      height\n    }\n    handle\n  }\n  query CollectionImage($handle: String!, $country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      ...CollectionImage\n    }\n  }\n': {
    return: CollectionImageQuery;
    variables: CollectionImageQueryVariables;
  };
  '#graphql\n  fragment S25Collection on Collection {\n    id\n    title\n    image {\n      id\n      url\n      altText\n      width\n      height\n    }\n    handle\n  }\n  query S25Collection($handle: String!, $country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      ...S25Collection\n    }\n  }\n': {
    return: S25CollectionQuery;
    variables: S25CollectionQueryVariables;
  };
  ...
  '#graphql\n  query ProductCollections($handle: String!) {\n    product(handle: $handle) {\n      collections(first: 10) {\n        nodes {\n          id\n          title\n          handle\n        }\n      }\n    }\n  }\n': {
    return: ProductCollectionsQuery;
    variables: ProductCollectionsQueryVariables;
  };
